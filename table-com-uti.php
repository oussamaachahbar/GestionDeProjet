...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title> TABLES DES COMMENTAIRES </title>
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <h2 id="color-changing-title"><span class="fa fa-arrow-circle-o-left"></span> COMMENTAIRE</h2>
...
.cadre-professionnel {
 ...
 <table class="table table-bordered small-width" style="margin-top:4em">
  <thead>
    <tr>
    <th scope="col">ID</th>  
  ...
  $sql = "SELECT * FROM commentaire where NOM='" . $_SESSION['nom'] . " " . $_SESSION['prenom'] . "'";
  $resultat =$conn->query($sql);
  if ($resultat) {
    while ($row =$resultat->fetch(PDO::FETCH_ASSOC)) {
        $id=$row['id'];
        $comm=$row['discription'];  
        $Nom = $row['NOM'];
        $date=$row['date'];
      ...
      <td scope="row">' . $comm. '</td>
              ...
              <td>
                <button class="btn btn-danger">
                  <a href="deletecomu.php?deleteid=' . $id . '" class="text-light">DELETE</a>
                </button></td>
                <td><button class="btn btn-warning" >
                <a href="updatecomu.php?updateid='.$id.'" class="text-light">UPDATE</a>
                </button> </td>
