        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> PHASE</h2>
                </div>
                <!-- END PAGE TITLE -->                
      ...
      <td scope="row">' . $Nom. '</td>
              ...
              <td>
                <button class="btn btn-danger">
                  <a href="deletephase.php?deleteide=' . $id . '" class="text-light">DELETE</a>
                </button></td>
                <td><button class="btn btn-warning" >
                <a href="updatephase.php?updateide='.$id.'" class="text-light">UPDATE</a>
                </button>
              </td>
